...
def open_out_file():        
    ...
    f.write('<body style="background-color: #985b45; background-image: url(emerald.jpg); color: #111111;">\n')
...
def create_output_html():
    ...
    f.write("<table border = 3; style = 'background-color: #59C3F1; margin: auto;'>")
    ...
    f.write('<tr><th>Last Name</th><th>First Name</th><th>Room Type</th><th>Num Nights</th><th>Subtotal</th><th>Sales Tax</th><th>Occupancy Tax</th><th>Total</th></tr>\n')
