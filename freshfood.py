# Name: Aiden Higginbotham and Xinnan Wei
...
def perform_calculations():
    ...
    #calculate deductions
        ...
        med = pay * DED_RATE[3]
        ret = pay * DED_RATE[4]
    # calculate other deductions here
...
def display_results ():
    ...
    print(line)
    titles1 = "Emp Name" + tab  + "Code" + "  Gross" + tab
    titles2 = "Fed Inc Tax" + tab + "State Inc Tax" + tab + "  Soc Sec" + tab + "  Medicare" + tab + "    Ret" + tab + "           Net"
